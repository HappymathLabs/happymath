...
| 用户请求 | 处理方式 |
|----------|----------|
| 撰写论文结构中的某部分（摘要、问题重述、模型假设、符号说明、参考文献、附录等） | 阅读「参考文档索引」中对应语言的部分内容撰写参考及获奖论文风格参考，并按其要求撰写。 |
